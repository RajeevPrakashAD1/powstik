...
const DiscountBar = () => {
	return (
		<DiscountContainer>
			...
			<DiscountDescription>
				<H1 size="36" lineHeight="45.25" color="black">
					Welcome to <Text1>Nutri</Text1>
				</H1>
				<P1 size="22" lineHeight="27.65" color="black" weight="700">
					Download the app and get <Text1>25% off</Text1> on the first order!
				</P1>
			</DiscountDescription>
			<DiscountDownload>
