		...
		<React.Fragment>
			<Container>
				<ProductContainer>
					...
					<Container1>
						<FilteredContainer>
							<Accordian Title={'Mothers&Child'} /> <Accordian Title={'Diabetes'} />{' '}
							<Accordian Title={'Geriatrics'} /> <Accordian Title={'Organic'} />{' '}
							<Accordian Title={'Neutraceuticals'} /> <Accordian Title={'Plant Based Foods'} />{' '}
							<P1
